...
function enqueue_dropzone_assets() {
  ...
  wp_enqueue_style( 'dropzone-css', get_theme_file_uri('/assets/css/vendor/dropzone/dropzone.css'), array(), '6.0.0-beta.2' );
}
function enqueue_nouislider() {
  wp_enqueue_script( 'nouislider-js', get_theme_file_uri('/assets/js/vendor/nouislider/nouislider.min.js'), array(), '1.0.0', true );
  wp_enqueue_style( 'nouislider-css', get_theme_file_uri('/assets/css/vendor/nouislider/nouislider.css'), array(), '1.0.0' );
}
...
function enqueue_swiper_js() {
  wp_enqueue_script( 'swiper-js', get_theme_file_uri('/assets/js/vendor/swiper/swiper-element-bundle.min.js'), array(), '11.2.8', true );
  wp_enqueue_style( 'swiper-css', get_theme_file_uri('/assets/css/vendor/swiper/swiper-bundle.min.css'), array(), '11.2.8' );
}
function enqueue_glide_js() {
  wp_enqueue_script( 'glide-js', get_theme_file_uri('/assets/js/vendor/glide/glide.min.js'), array(), '11.2.8', true );
  wp_enqueue_style( 'glide-css', get_theme_file_uri('/assets/css/vendor/glide/glide.core.min.css'), array(), '11.2.8' );
}
