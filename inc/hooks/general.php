...
function registrar_widgets( ) {
  register_sidebar( array(
    'name' => esc_html__( 'Sidebar de Pesquisa', 'air-light' )
    , 'id' => 'pesquisa-sidebar'
    , 'description' => esc_html__( 'Adicione widgets aqui para aparecer na barra lateral de pesquisa.', 'air-light' )
