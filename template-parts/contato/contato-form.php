<?php
$nome = isset( $_REQUEST['nome'] ) ?? htmlspecialchars( sanitize_text_field( $_REQUEST['nome'] ), ENT_QUOTES, 'UTF-8' );
$email = isset( $_REQUEST['email'] ) ?? htmlspecialchars( sanitize_email( $_REQUEST['email'] ), ENT_QUOTES, 'UTF-8' );
$telefone = isset( $_REQUEST['telefone'] ) ?? htmlspecialchars( sanitize_text_field( $_REQUEST['telefone'] ), ENT_QUOTES, 'UTF-8' );
$mensagem = isset( $_REQUEST['mensagem'] ) ?? htmlspecialchars( sanitize_text_field( $_REQUEST['mensagem'] ), ENT_QUOTES, 'UTF-8' );
