...
<div class="exibir-resultado">
  ...
  <form name="show" action="#" class="show">
    ...
    <select name="max" id="max">
      <option value="4" <?php echo ( 4 == intval( $max ) ) ? 'selected' : ''; ?>>4</option>
      <option value="8" <?php echo ( 8 == intval( $max ) ) ? 'selected' : ''; ?>>8</option>
      <option value="12" <?php echo ( 12 == intval( $max ) ) ? 'selected' : ''; ?>>12</option>
      <option value="24" <?php echo ( 24 == intval( $max ) ) ? 'selected' : ''; ?>>24</option>
      <option value="36" <?php echo ( 36 == intval( $max ) ) ? 'selected' : ''; ?>>36</option>
      <option value="48" <?php echo ( 48 == intval( $max ) ) ? 'selected' : ''; ?>>48</option>
    </select>
  </form>
</div>
