<?php
  function custom_tag_cloud_format_regiao( $return, $tags, $args ) {
  ...
  add_filter( 'wp_generate_tag_cloud', 'custom_tag_cloud_format_regiao', 10, 3 );
?>
<article class="tag-cloud regiao">
  <header><h4>Bairros</h4></header>
  <?php
    wp_tag_cloud( array(
      'smallest' => 18
    , 'largest' => 18
