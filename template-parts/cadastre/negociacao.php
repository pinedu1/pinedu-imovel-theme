...
$valor_venda = isset( $_REQUEST['valorVenda'] ) ?? intval( $_REQUEST['valorVenda'] );
$valor_locacao = isset( $_REQUEST['valorLocacao'] ) ?? intval( $_REQUEST['valorLocacao'] );
?>
<div class="row row-half">
  ...
  <div class="col col-valor">
    <input type="number" class="form-control" id="valorVenda" name="valorVenda" placeholder="Valor de Venda" value="<?php echo $valor_venda; ?>" disabled required title="Valor de Venda. ( Ative este campo para definir um valor )">
  </div>
...
<div class="row row-half">
  ...
  <div class="col col-valor">
    <input type="number" class="form-control" id="valorLocacao" name="valorLocacao" placeholder="Valor de Locação" value="<?php echo $valor_locacao; ?>" disabled required title="Valor de Venda. ( Ative este campo para definir um valor )">
  </div>
  <div class="flex-spacer"></div>
</div>
